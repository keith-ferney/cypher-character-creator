                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Character Sheet</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Create and manage your Cypher System characters. Build your character from descriptors,
                                types, and foci. Track your abilities, skills, equipment, and more.
                            </p>
                        </div>
